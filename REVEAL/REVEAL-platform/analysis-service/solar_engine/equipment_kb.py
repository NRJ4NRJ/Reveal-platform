"""
equipment_kb.py — Equipment knowledge base for the REPAT solar platform
=============================================================
...
SOLAR_INVERTER_SPECS: dict[str, dict[str, dict[str, float]]] = {
    ...
    "GoodWe": {
        "GW100K-HT": {"ac_kw": 100.0},
        "GW150K-HT": {"ac_kw": 150.0},
        "GW250K-HT": {"ac_kw": 250.0},
    },
    "Growatt": {
        "MAX 100KTL3-MV": {"ac_kw": 100.0},
        "MAX 150KTL3-X": {"ac_kw": 150.0},
        "MAX 250KTL3-MV": {"ac_kw": 250.0},
    },
    "TMEIC": {
        "PVL-680": {"ac_kw": 680.0},
        "PVL-1000": {"ac_kw": 1000.0},
        "TMdrive-XL85": {"ac_kw": 4320.0},
    },
    "Other": {},
}
