...
def _render_html(*, site_cfg, report_date, logo_b64, cover_img_b64="", irradiance, site_totals,
    ...
    # ── Logo ──────────────────────────────────────────────────────────────────
    logo_img = (f'<img src="{logo_b64}" alt="REVEAL" />'
                if logo_b64 else "")
...
"""
  ...
  <span>CONFIDENTIAL — REVEAL | 8p2 Advisory</span>
...
def _fpdf2_pdf(
    ...
    *,
    ...
    def draw_footer(n: int, total: int = 6):
        ...
        pdf.cell(64, 5, "CONFIDENTIAL -- REVEAL | 8p2 Advisory", align="C")
    ...
    pdf.set_font("Helvetica", "B", 12)
    pdf.set_text_color(*WHITE)
    pdf.cell(PAGE_W - 15, 7, "REVEAL | 8p2 Advisory", align="R")
    pdf.set_xy(10, 13)
    pdf.set_font("Helvetica", "", 8)
    pdf.set_text_color(200, 220, 240)
